...
func TestBaseBikerMessaging(t *testing.T) {
	...
	if biker1.OtherBikerReputation != 5 || biker2.OtherBikerReputation != 5 {
		t.Errorf("Expected both biker1 and biker2 reputations to be 5, but got biker1=%d and biker2=%d", biker1.OtherBikerReputation, biker2.OtherBikerReputation)
	}
}
